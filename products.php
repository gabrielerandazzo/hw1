    ...
    <header>
        <div class="header-container">
            <div id="riga1">
                ...
                <a id="header-autodoc-image" href="index.php">
            ...
            <div id="riga2">
                ...
                <form class="header-search" autocomplete="on">

                    <input type="text" id="search-input" placeholder="Inserisca il numero del pezzo o il nome"
                        name="keyword">
                ...
                <div class="header-right" id="cart-info" onclick="location.href = 'cart.php'">
                    <div class="header-icon-text" id="cart-info-icon-text">
                        ...
                        <div class="header-right-text-container">
                            ...
                            <span id="numero-articoli"
                                class="header-right-text-bottom">#<?php echo $_SESSION['cart_id']; ?></span>
                        </div>
